...
const _secrets = JSON.parse(require('fs').readFileSync(require('path').join(__dirname, '.banf-secrets.json'), 'utf8'));
const GMAIL_OAUTH = {
...
const EC_MEMBERS = {
  ...
  'sumo475@gmail.com':              { name: 'Dr. Sumanta Ghosh', role: 'Event Coordinator', ecTitle: 'Event Coordinator' },
