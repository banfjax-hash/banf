...
const GMAIL = {
  CLIENT_ID: _secrets2.CLIENT_ID,
  CLIENT_SECRET: _secrets2.CLIENT_SECRET,
  REFRESH_TOKEN: _secrets2.REFRESH_TOKEN
};
...
const EC_MEMBERS = {
  ...
  'sumo475@gmail.com':              { name: 'Dr. Sumanta Ghosh', role: 'Event Coordinator', approvalLevel: 0 },
