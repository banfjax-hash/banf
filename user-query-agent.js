 ...
 *
 *  Architecture:
 *    1. CLASSIFIER ΓÇö Categorizes incoming emails (drive vs query, safe vs human-required)
 *    2. PLANNER    ΓÇö Creates execution plan for multi-step responses
 *    3. REASONER   ΓÇö Determines confidence level and response strategy
 *    4. EXECUTOR   ΓÇö Executes the plan (data lookup, agent coordination, email drafting)
 *    5. APPROVER   ΓÇö Human-in-the-loop approval workflow for learning
 *
...
class ReasonerAgent {
  ...
  generateResponse(email, classification, planResults, memberData) {
    // ΓöÇΓöÇ SMART NAME RESOLUTION ΓöÇΓöÇ
    // Don't blindly use CRM name ΓÇö check if email body indicates a different person
    ...
    // Check if THIS email contains a name change request ΓÇö use the new name
...
- **Current Status:** ${isCurrent ? 'Γ£à Active for FY2026-27' : 'Γ¥î Not active for FY2026-27'}
    ...
    if (updates.length > 0) {
      changesText = updates.map(u => {
        if (u.field === 'name' && u.action === 'change') {
          return `- **Name Update:** ${u.oldValue ? `${u.oldValue} ΓåÆ ` : ''}${u.newValue}`;
...
class ExecutorAgent {
  ...
  parseUpdate(body) {
    ...
    // ΓöÇΓöÇ NAME CHANGE DETECTION ΓöÇΓöÇ
...
class ApprovalWorkflow {
  ...
  async sendApprovalEmail(approval, accessToken) {
    ...
    const subject = `≡ƒöì Query Response Approval: ${approval.classification.category} [${approval.id}]`;
...
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 700px; margin: 0 auto; padding: 20px;">
    <div style="background: linear-gradient(135deg, #8B0000, #DC143C); padding: 20px; border-radius: 12px 12px 0 0;">
        <h1 style="color: #fff; margin: 0; font-size: 22px;">≡ƒñû User Query Agent ΓÇö Approval Request</h1>
    ...
    <div style="background: #f5f5f5; padding: 25px; border: 1px solid #ddd; border-top: none;">
        ...
        <div style="background: #fff; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #007bff;">
            <h3 style="margin: 0 0 10px 0; color: #007bff;">≡ƒôº Original Email</h3>
        ...
        <div style="background: #fff; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #ffc107;">
            <h3 style="margin: 0 0 10px 0; color: #856404;">≡ƒÅ╖∩╕Å Classification</h3>
        ...
        <div style="background: #fff; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #17a2b8;">
            <h3 style="margin: 0 0 10px 0; color: #117a8b;">≡ƒºá Agent Reasoning</h3>
        ...
        <div style="background: #fff; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #28a745;">
            <h3 style="margin: 0 0 10px 0; color: #155724;">≡ƒô¥ Suggested Response</h3>
...
async function cmdProcess() {
  ...
  console.log('  ≡ƒñû USER QUERY AGENT ΓÇö Processing New Queries');
  console.log('ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ\n');
...
async function cmdPending() {
  ...
  console.log('ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ');
  console.log('  ≡ƒôï PENDING APPROVALS');
  console.log('ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ\n');
...
async function cmdStats() {
  ...
  console.log('ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ');
  console.log('  ≡ƒôè USER QUERY AGENT STATISTICS');
  console.log('ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ\n');
  ...
  for (const [cat, data] of Object.entries(stats.categoryStats)) {
    ...
    const autoReady = rate >= 85 && total >= 20 ? 'Γ£à' : 'ΓÅ│';
