 ...
 *    1. Amount ΓåÆ membership tier price matching
 ...
 *    5. Amount pattern analysis (round numbers ΓåÆ donation?)
 *
 *  Usage:
...
// ΓöÇΓöÇ Membership Pricing Matrix (FY2026-27) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Known Sponsorship Tiers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Event Fee Ranges ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Keyword Patterns ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function classifyPayment(payment, memberData = null, context = {}) {
    ...
    // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    // Signal 2: AMOUNT ΓåÆ MEMBERSHIP TIER MATCHING (weight: 35)
    // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    const tierMatches = [];
    ...
    for (const [tierKey, tier] of Object.entries(SPONSORSHIP_TIERS)) {
        if (amount >= tier.min && amount <= tier.max) {
            ...
            signals.push({
                ...
                purpose: 'sponsorship',
                weight: 30,
                detail: `$${amount} falls in ${tier.name} sponsorship range ($${tier.min}-$${tier.max === Infinity ? 'Γê₧' : tier.max})`
            });
            break;
        }
    }
    ...
    if (memberData) {
        ...
        if (membershipPaid) {
            // Already paid membership ΓåÆ likely sponsorship or donation
            ...
            signals.push({
                ...
                weight: 20,
                detail: `Member already has membership for FY${fy} ΓåÆ likely sponsorship or donation`
            });
        } else {
            // No membership this FY ΓåÆ boost membership score
            scores.membership += 15;
            signals.push({
                type: 'membership_unpaid',
                purpose: 'membership',
                weight: 15,
                detail: `No membership recorded for FY${fy} ΓåÆ likely membership payment`
            });
        }
    ...
    // ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    // Round numbers (100, 200, 500, 1000) ΓåÆ more likely donation
    if (amount >= 50 && amount % 50 === 0 && !tierMatches.some(t => t.diff === 0)) {
        ...
        signals.push({
            ...
            purpose: 'donation',
            weight: 8,
            detail: `$${amount} is a round number ΓÇö possibly a donation`
        });
    }

    // Very small amounts ΓåÆ event fee or guest pass
    if (amount > 0 && amount <= 50) {
        ...
        signals.push({
            ...
            purpose: 'event_fee',
            weight: 5,
            detail: `$${amount} is small ΓÇö possibly event fee or guest pass`
        });
    }

    // Very large amounts ΓåÆ sponsorship
    if (amount >= 500 && !tierMatches.some(t => t.diff === 0)) {
        ...
        signals.push({
            ...
            purpose: 'sponsorship',
            weight: 15,
            detail: `$${amount} is high ΓÇö likely sponsorship`
        });
    }
...
function getFiscalYear(date) {
    // BANF fiscal year: April 1 ΓÇô March 31
...
function generatePaymentAcknowledgment(classification) {
    ...
    if (purpose === 'membership' && tierMatch) {
        ...
        return `Payment of $${amount} received from ${payer}. ` +
               `Classified as: MEMBERSHIP ΓÇö ${matchNote} (${confidence}% confidence).`;
    }
    ...
    if (purpose === 'sponsorship') {
        ...
        return `Payment of $${amount} received from ${payer}. ` +
               `Classified as: SPONSORSHIP (${tierName}) ΓÇö ${confidence}% confidence.`;
    }

    if (purpose === 'donation') {
        return `Payment of $${amount} received from ${payer}. ` +
               `Classified as: DONATION ΓÇö ${confidence}% confidence.`;
    }

    return `Payment of $${amount} received from ${payer}. ` +
           `Classified as: ${purpose.toUpperCase()} ΓÇö ${confidence}% confidence.`;
}
